        ...
        const mockActivity = {
          ...
          steps: [
            ...
            },
            {
              ...
              description: 'Resolving potential scheduling conflicts',
            ...
            },
            {
              ...
              description: 'Booking appointment and sending confirmation',
              timestamp: new Date(Date.now() - 500),
              status: 'PENDING',
              confidence: 0.99,
              reasoning: 'All checks passed, ready to confirm booking',
              metrics: { processingTime: 0.5, dataPoints: 3 }
            }
          ],
          explanation: {
            decision: 'Scheduled appointment for 2:30 PM on March 15th',
      ...
      <div className="bg-white rounded-lg shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="bg-gray-100 p-4 border-t border-gray-200 flex items-center justify-between">
          <div className="text-sm text-gray-600">
            <span>Agent: <span className="font-medium">{activity.agentId}</span></span>
            <span className="mx-2">|</span>
            <span>Activity ID: <span className="font-medium">{activity.id}</span></span>
          </div>
          <div className="flex items-center space-x-2">
            <button className="px-4 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 transition-colors">Export Details</button>
          </div>
        </div>
      </div>
    </div>
