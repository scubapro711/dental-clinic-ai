...
class RealisticMockOdooClient:
    ...
    def create_patient(
        ...
        **kwargs
        ...
        self.patients.append(patient)
        logger.info(f"Mock: Created patient {name} (ID: {new_id})")
        return new_id
    ...
    def update_patient(self, patient_id: int, **kwargs) -> bool:
        ...
        logger.warning(f"Mock: Patient {patient_id} not found for update")
        return False
        ...
        for appt in self.appointments:
            if appt["id"] == appointment_id:
                return {
                    ...
                    "physician_id": appt.get("doctor_id"),
                    "physician_name": appt.get("doctor_name", "Unknown"),
                    "appointment_date": appt["date"],
                    "appointment_end": appt.get("end_time"),
                    "state": appt["status"],
                    "notes": appt.get("notes", ""),
                }
        
        logger.warning(f"Mock: Appointment {appointment_id} not found")
        return None
    ...
    def search_appointments(
        ...
        for appt in self.appointments:
            ...
            # Filter by physician_id
            if physician_id and appt.get("doctor_id") != physician_id:
                continue
            ...
            # Filter by state
            if state and appt["status"] != state:
                continue
        ...
        logger.info(f"Mock: Found {len(results)} appointments matching criteria")
        return results
