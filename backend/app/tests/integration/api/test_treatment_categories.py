"""
Integration Tests for TreatmentCategories API Endpoints

Tests for the treatment_categories endpoints including:
...
class TestTreatmentCategoriesEndpoints:
    """Test suite for treatment_categories API endpoints."""
