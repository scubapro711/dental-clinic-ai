"""
Integration Tests for ProactiveSuggestions API Endpoints

Tests for the proactive_suggestions endpoints including:
...
class TestProactiveSuggestionsEndpoints:
    """Test suite for proactive_suggestions API endpoints."""
