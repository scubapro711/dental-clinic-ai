"""
Integration Tests for ToothChart API Endpoints

Tests for the tooth_chart endpoints including:
...
class TestToothChartEndpoints:
    """Test suite for tooth_chart API endpoints."""
