"""
Integration Tests for SecurityIncidents API Endpoints

Tests for the security_incidents endpoints including:
...
class TestSecurityIncidentsEndpoints:
    """Test suite for security_incidents API endpoints."""
