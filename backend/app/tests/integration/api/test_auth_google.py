"""
Integration Tests for AuthGoogle API Endpoints

Tests for the auth_google endpoints including:
...
class TestAuthGoogleEndpoints:
    """Test suite for auth_google API endpoints."""
