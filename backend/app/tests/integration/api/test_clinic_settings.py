"""
Integration Tests for ClinicSettings API Endpoints

Tests for the clinic_settings endpoints including:
...
class TestClinicSettingsEndpoints:
    """Test suite for clinic_settings API endpoints."""
