"""
Integration Tests for TelegramAdmin API Endpoints

Tests for the telegram_admin endpoints including:
...
class TestTelegramAdminEndpoints:
    """Test suite for telegram_admin API endpoints."""
