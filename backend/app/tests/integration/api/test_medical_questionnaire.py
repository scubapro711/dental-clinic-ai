"""
Integration Tests for MedicalQuestionnaire API Endpoints

Tests for the medical_questionnaire endpoints including:
...
class TestMedicalQuestionnaireEndpoints:
    """Test suite for medical_questionnaire API endpoints."""
