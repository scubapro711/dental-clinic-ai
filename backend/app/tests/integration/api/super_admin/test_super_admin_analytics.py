"""
Integration Tests for SuperAdminAnalytics API Endpoints

Tests for the super_admin/analytics endpoints including:
...
class TestSuperAdminAnalyticsEndpoints:
    """Test suite for super_admin/analytics API endpoints."""
