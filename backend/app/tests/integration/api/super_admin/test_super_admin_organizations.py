"""
Integration Tests for SuperAdminOrganizations API Endpoints

Tests for the super_admin/organizations endpoints including:
...
class TestSuperAdminOrganizationsEndpoints:
    """Test suite for super_admin/organizations API endpoints."""
