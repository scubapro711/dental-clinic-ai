"""
Integration Tests for PilotApplications API Endpoints

Tests for the pilot_applications endpoints including:
...
class TestPilotApplicationsEndpoints:
    """Test suite for pilot_applications API endpoints."""
