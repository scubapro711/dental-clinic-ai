"""
Integration Tests for UserPatientMapping API Endpoints

Tests for the user_patient_mapping endpoints including:
...
class TestUserPatientMappingEndpoints:
    """Test suite for user_patient_mapping API endpoints."""
