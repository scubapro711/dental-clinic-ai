"""
Integration Tests for TeamInvitations API Endpoints

Tests for the team_invitations endpoints including:
...
class TestTeamInvitationsEndpoints:
    """Test suite for team_invitations API endpoints."""
