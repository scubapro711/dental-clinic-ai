"""
Integration Tests for MockPatientAuth API Endpoints

Tests for the mock_patient_auth endpoints including:
...
class TestMockPatientAuthEndpoints:
    """Test suite for mock_patient_auth API endpoints."""
