"""
Integration Tests for DataRetention API Endpoints

Tests for the data_retention endpoints including:
...
class TestDataRetentionEndpoints:
    """Test suite for data_retention API endpoints."""
