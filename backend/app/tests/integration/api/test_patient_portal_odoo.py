"""
Integration Tests for PatientPortalOdoo API Endpoints

Tests for the patient_portal_odoo endpoints including:
...
class TestPatientPortalOdooEndpoints:
    """Test suite for patient_portal_odoo API endpoints."""
