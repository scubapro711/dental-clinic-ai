"""
Integration Tests for TreatmentPrices API Endpoints

Tests for the treatment_prices endpoints including:
...
class TestTreatmentPricesEndpoints:
    """Test suite for treatment_prices API endpoints."""
