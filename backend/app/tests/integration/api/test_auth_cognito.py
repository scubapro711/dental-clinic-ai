"""
Integration Tests for AuthCognito API Endpoints

Tests for the auth_cognito endpoints including:
...
class TestAuthCognitoEndpoints:
    """Test suite for auth_cognito API endpoints."""
